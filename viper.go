...
import (
	...
	"github.com/setrofim/viper/internal/encoding"
	"github.com/setrofim/viper/internal/encoding/dotenv"
	"github.com/setrofim/viper/internal/encoding/hcl"
	"github.com/setrofim/viper/internal/encoding/ini"
	"github.com/setrofim/viper/internal/encoding/javaproperties"
	"github.com/setrofim/viper/internal/encoding/json"
	"github.com/setrofim/viper/internal/encoding/toml"
	"github.com/setrofim/viper/internal/encoding/yaml"
)
...
func (v *Viper) mergeFoundMaps(lcaseKey string, found []interface{}) interface{} {
	...
	for _, fv := range found {
		...
		if err != nil {
			// A non-map value found. This showns everything else
...
func (v *Viper) getKeyValueConfig() error {
	if RemoteConfig == nil {
		return RemoteConfigError("Enable the remote features by doing a blank import of the viper/remote package: '_ github.com/setrofim/viper/remote'")
	}
